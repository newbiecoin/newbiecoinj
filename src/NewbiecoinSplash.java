...
//public class NewbiecoinSplash extends Application implements ActionListener {
//	private Scene scene;
...
//		NewbiecoinSplash newbiecoinSplash = new NewbiecoinSplash();
//		newbiecoinSplash.initiateSplash();
//		newbiecoinSplash.renderSplashFrame("Synchronizing with Blockchain...");
//		newbiecoinSplash.splash.update();
//		 
...
////        while (!blocksRunnable.blocks.getInstance().status.equals("Blockchain synchronization complete. Launching Newbiecoin.")) {
////        	System.out.println("loop");
////        	newbiecoinSplash.renderSplashFrame(blocksRunnable.blocks.getInstance().status);
////            newbiecoinSplash.splash.update();
////            try {
////                Thread.sleep(90);
////            } catch(InterruptedException e) {
...
//}
//
//class NewbiecoinBrowser extends Region {
//
...
//		Button buttonHome = new Button("Newbiecoin wallet");    
//
